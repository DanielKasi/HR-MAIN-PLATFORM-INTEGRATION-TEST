...
urlpatterns = [
    ...
    path("<int:spotcheck_id>/spotcheck/create/", SpotCheckViews.EmployeeStopCheckCreateView.as_view(), name='employee-spotcheck-create'),
    path("<int:spotcheck_id>/spotcheck/details/", SpotCheckViews.EmployeeStopCheckDetailView.as_view(), name='employee-spotcheck-detail'),
    path("<int:spotcheck_id>/spotcheck/checkin/", SpotCheckViews.EmployeeStopCheckUpdateView.as_view(), name='employee-spotcheck-update'),
]
