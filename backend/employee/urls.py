...
urlpatterns = [
    ...
    # path('<int:id>/resend-welcome-email/', ResendWelcomeLink, name='resend-welcome-link'),
    path('resend-welcome-email/<int:employee_id>/', ResendWelcomeLink.as_view(), name='resend-welcome-link'),
