...
from .views import CaptureFace, CaptureFingerPrint, CopyUserToDevice, DeviceCallbackView, DeviceDetailView, DeviceListCreateView, DeviceEmployeeAttachmentListCreateView, DeviceEmployeeAttachmentDetailView
...
urlpatterns = [
    ...
    path('capture-face/', CaptureFace.as_view(), name='capture-face'),
]
