...
# spotcheck settings
SPOTCHECK_DEFAULT_MINUTES_TO_EXPIRE = int(os.getenv("SPOTCHECK_DEFAULT_MINUTES_TO_EXPIRE", 50))
...
SPOTCHECK_DEFAULT_LATE_STARTS_AFTER_MINUTES = int(os.getenv("SPOTCHECK_DEFAULT_UPPER_THRESHOLD", 20))
