...
import { Search, Plus, Edit, Trash2, Loader2, Eye, ChevronLeft, ChevronRight, MoreVertical } from "lucide-react"
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow className="bg-gray-50 border-b border-gray-200">
                                        <TableHead className="font-semibold text-gray-900 py-4 px-6">Bank Name</TableHead>
                                        <TableHead className="font-semibold text-gray-900 py-4 px-6">Bank Code</TableHead>
