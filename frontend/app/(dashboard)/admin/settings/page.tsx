              ...
              <div className="flex flex-col items-center text-center space-y-4">
                <div className="relative">
                  {institution?.institution_logo || logoFile ? (
                    <div className="!w-20 !h-20 !aspect-square rounded-lg overflow-hidden relative">
                      <Image
                        fill
                        src={
                          logoFile
                        ...
                        className="!w-full !h-full !min-w-20 aspect-square object-cover object-center"
                      />
                    </div>
                  ) : (
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500 mb-2">
                    Enable penalties for late arrivals and early departures
                  </p>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          Upload required KYC documents for your institution
                        </p>
                      </div>
                      <Button
                        variant="outline"
