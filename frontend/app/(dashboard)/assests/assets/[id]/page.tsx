      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              {asset.asset_histories && asset.asset_histories.length > 0 ? (
                <div className="space-y-4">
                  {asset.asset_histories.map((history: IAssetHistory, index: number) => (
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between">
                          <p className="text-sm font-medium text-gray-900">
                            {getEventTypeDisplay(history.event_type)}
                          </p>
                        ...
                        {history.performed_by_details && (
                          <p className="text-xs text-gray-500 mt-1">
                            By: {history.performed_by_details.fullname || `User ID: ${history.performed_by}`}
                          </p>
                        )}
                        {history.affected_user_details && (
                          <p className="text-xs text-gray-500">
                            Affected: {history.affected_user_details.fullname || `User ID: ${history.affected_user}`}
                          </p>
                        )}
                      </div>
                    </div>
