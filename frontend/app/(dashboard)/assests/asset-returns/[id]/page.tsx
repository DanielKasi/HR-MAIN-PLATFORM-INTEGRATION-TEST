            ...
            <div className="border-gray-200 p-4 ">
              ...
              <div className="space-y-4 lg:space-y-6">
                <div className="relative">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 lg:w-8 lg:h-8 rounded-full flex items-center justify-center flex-shrink-0 border-2 bg-green-100 border-green-500">
                    ...
                    <div className="flex flex-col bg-gray-50 rounded-lg p-3 lg:p-4 flex-1">
                      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 justify-between">
                        <h4 className="text-sm font-medium text-gray-900">Asset Returned</h4>
                        <Badge className="text-xs mt-1 bg-green-100 text-green-800 border-green-200">
                          Completed
                        </Badge>
                      </div>
                      <p className="text-xs text-gray-500 mt-1">
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Condition: {getConditionDisplay(assetReturn.condition)}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 lg:w-8 lg:h-8 rounded-full flex items-center justify-center flex-shrink-0 border-2 bg-blue-100 border-blue-400">
                    ...
                    <div className="flex flex-col bg-gray-50 rounded-lg p-3 lg:p-4 flex-1">
                      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 justify-between">
                        <h4 className="text-sm font-medium text-gray-900">Asset Processing</h4>
                        <Badge className="text-xs mt-1 bg-blue-100 text-blue-800 border-blue-200">
                          Pending
                        </Badge>
                      </div>
                      <p className="text-xs text-gray-500 mt-1">
                ...
                <div className="relative">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex flex-col bg-gray-50 rounded-lg p-3 lg:p-4 flex-1">
                      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 justify-between">
                        <h4 className="text-sm font-medium text-gray-900">Asset Available</h4>
                        <Badge className="text-xs mt-1 bg-blue-100 text-blue-800 border-blue-200">
                          Pending
                        </Badge>
                      </div>
