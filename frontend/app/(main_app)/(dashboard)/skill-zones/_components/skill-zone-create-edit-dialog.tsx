...
import { ISkillZone, ISkillZoneFormData, ISkillZoneCategory } from "@/types/recruitment.types";
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			...
			<DialogContent>
				...
				<DialogFooter>
					<Button className="w-full rounded-full" onClick={handleCreateOrUpdate} disabled={saving}>
						{saving ? "Saving..." : "Save"}
					</Button>
				</DialogFooter>
			</DialogContent>
