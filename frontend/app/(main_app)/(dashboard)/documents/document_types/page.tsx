                    ...
                    <CardContent>
                        {documentTypes.length === 0 ? (
                            <div className="text-center py-8">
                                ...
                                <p className="text-muted-foreground mb-4">Get started by creating your first document type</p>
                                            ...
                                            <TableCell className="text-right">
                                                <div className="flex items-center justify-end gap-2">
                                                    <ProtectedComponent permissionCode={PERMISSION_CODES.CAN_EDIT_DOCUMENT_TYPES}>
                                                        <Button variant="outline" size="sm" onClick={() => openEditDialog(documentType)}>
                                                            <Edit className="h-4 w-4" />
                                                        </Button>
                                                    </ProtectedComponent>
                                                    <ProtectedComponent permissionCode={PERMISSION_CODES.CAN_DELETE_DOCUMENT_TYPES}>
                                                        <AlertDialog>
