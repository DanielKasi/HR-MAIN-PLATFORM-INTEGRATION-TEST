  ...
  return (
    <div className="w-full h-full bg-white rounded-xl p-6">
      <div className="w-full space-y-8">
        ...
        <div className={` gap-6 ${(jobAdvert?.approval_status !== "active" && jobAdvert?.approvals?.length) ? "!grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-3" : ""}`}>
          ...
          <div className={`${(jobAdvert?.approval_status !== "active" && jobAdvert?.approvals?.length) ? "lg:col-span-2 xl:col-span-3 order-2 lg:order-1" : ""}`}>
