  ...
  return (
    <div className="w-full h-full p-4 rounded-xl bg-white">
      <div className="w-full space-y-6">
        ...
        <div className={` gap-6 ${(jobPosition?.approval_status !== "active" && jobPosition.approvals?.length) ? "!grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-3" : ""}`}>
          ...
          {/* Main Details Card */}
          <Card className={` shadow-none border-none bg-transparent ${(jobPosition.approval_status !== "active" && jobPosition.approvals?.length) ? "lg:col-span-2 xl:col-span-3 order-2 lg:order-1" : ""}`}>
            <CardHeader>
