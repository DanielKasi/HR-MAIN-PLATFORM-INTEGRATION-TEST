			...
			<Card className="w-full mt-4 border-none shadow-none">
				...
				<CardContent className="space-y-6">
					<p className="text-gray-700">
						You have been requested to check in for a spot check. We need access to your device
						location to verify your check-in.
					</p>
					...
					<div className="text-sm text-gray-500">
						Your location will only be used to validate this check-in.
					</div>
				</CardContent>
			</Card>
