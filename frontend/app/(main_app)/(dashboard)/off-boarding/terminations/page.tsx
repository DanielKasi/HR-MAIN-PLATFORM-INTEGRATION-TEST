				...
				<div className=" border-gray-200">
					<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
						...
						<div className="flex items-center gap-2">
							<ProtectedComponent
								permissionCode={PERMISSION_CODES.CAN_CREATE_TERMINATION_INITIATIONS}
							>
														...
														<TableCell className="text-right">
															<DropdownMenu>
																...
																<DropdownMenuContent align="end">
																	<ProtectedComponent
																		permissionCode={
																			PERMISSION_CODES.CAN_VIEW_TERMINATION_INITIATIONS
																		}
																	>
																	...
																	<ProtectedComponent
																		permissionCode={
																			PERMISSION_CODES.CAN_EDIT_TERMINATION_INITIATIONS
																		}
																	>
																	...
																	<ProtectedComponent
																		permissionCode={
																			PERMISSION_CODES.CAN_DELETE_TERMINATION_INITIATIONS
																		}
																	>
																		<DropdownMenuItem
