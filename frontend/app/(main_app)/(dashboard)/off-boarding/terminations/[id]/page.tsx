...
export default function TerminationInitiationDetailsPage() {
  ...
  return (
    <div className="w-full p-4 bg-white rounded-xl">
      ...
      <div className={` gap-6 ${(termination?.approval_status !== "active" && termination?.approvals?.length) ? "!grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-3" : ""}`}>
        ...
        <div className={`${(termination?.approval_status !== "active" && termination?.approvals?.length) ? "lg:col-span-2 xl:col-span-3 order-2 lg:order-1" : ""}`}>
