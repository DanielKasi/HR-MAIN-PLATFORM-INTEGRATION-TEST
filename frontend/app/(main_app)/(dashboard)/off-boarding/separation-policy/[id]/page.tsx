...
export default function SeparationPolicyDetailsPage() {
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className={` gap-6 ${(policy?.approval_status !== "active" && policy?.approvals?.length) ? "!grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-3" : ""}`}>
        ...
        <div className={`${(policy?.approval_status !== "active" && policy?.approvals?.length) ? "lg:col-span-2 xl:col-span-3 order-2 lg:order-1" : ""}`}>
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          <span className="font-medium">{policy.separation_type?.separation_type}</span>
