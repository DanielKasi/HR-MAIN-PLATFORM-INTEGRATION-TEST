...
// console.log("Employee", employee)
  ...
  return (
    <div className="flex flex-col gap-6 bg-white rounded-lg min-h-screen p-6">
      ...
      <div className={` gap-6 ${(user?.approval_status !== "active" && user?.approvals?.length) ? "!grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-3" : ""}`}>
        ...
        <div className={`${(user?.approval_status !== "active" && user?.approvals?.length) ? "lg:col-span-2 xl:col-span-3 order-2 lg:order-1" : ""}`}>
            ...
            <CardContent className="p-0">
              ...
              <div className="border-t border-[#e5e7eb]">
                <div className="flex border-b border-[#e5e7eb]">
                  ...
                  <button
                    className={`px-6 py-3 text-sm font-medium ${activeTab === "permissions"
                      ? "border-b-2 border-primary text-primary"
                      : "text-[#666]"
                      }`}
                  ...
                  <button
                    className={`px-6 py-3 text-sm font-medium ${activeTab === "attendance"
                      ? "border-b-2 border-primary text-primary"
                      : "text-[#666]"
                      }`}
