			...
			<div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12">
						...
						<Card className="bg-white border">
							<CardContent className="p-4">
								<div>
									...
									<p className="text-lg font-bold text-gray-900">
										{formatCurrency(
											parseFloat(payslipInfo.gross_salary || "0") +
												parseFloat(payslipInfo.taxable_allowances || "0"),
										)}
									</p>
								</div>
							</CardContent>
				...
				<Card className="bg-white border">
					<CardContent className="p-4">
						<div className="flex items-center justify-between">
							<div>
								<p className="text-sm font-medium text-black">Taxable allowances</p>
								<p className="text-xl font-bold text-green-600">
				...
				<Card className="bg-white border">
					<CardContent className="p-4">
						<div className="flex items-center justify-between">
							<div>
								<p className="text-sm font-medium text-black">Non taxable allowances</p>
								<p className="text-xl font-bold text-green-600">
					...
					<CardContent className="p-4">
						<div className="flex items-center justify-between">
							<div>
								...
								<p className="text-xl font-bold text-myOrange">{formatCurrency(totals.overtime)}</p>
							</div>
