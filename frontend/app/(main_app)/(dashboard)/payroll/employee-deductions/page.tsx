					...
					>
						{({ data, loading, refresh }) => {
							...
							const filteredResults = data.results.filter((deduction) => {
								...
								const matchesMethod =
									methodFilter === "all" || deduction.calculation_method === methodFilter;
							...
							return (
								<>
									<ProtectedComponent
										permissionCode={PERMISSION_CODES.CAN_VIEW_EMPLOYEE_DEDUCTIONS}
									>
										{/* Desktop Table */}
												...
												<TableBody>
													{filteredResults.map((deduction) => (
														<TableRow key={deduction.id}>
															...
															<TableCell>
																{new Date(deduction.created_at).toLocaleDateString("en-US", {
																	year: "numeric",
																	month: "short",
																	day: "numeric",
																})}
															...
															<TableCell>
																<DropdownMenu>
																	...
																	<DropdownMenuContent align="end">
																		...
																		<ProtectedComponent
																			permissionCode={
																				PERMISSION_CODES.CAN_DELETE_EMPLOYEE_DEDUCTIONS
																			}
																		>
																			<DropdownMenuItem
													...
													<div className="flex items-start justify-between mb-3">
														...
														<DropdownMenu>
															...
															<DropdownMenuContent align="end">
																...
																<ProtectedComponent
																	permissionCode={PERMISSION_CODES.CAN_DELETE_EMPLOYEE_DEDUCTIONS}
																>
																	<DropdownMenuItem
																		onClick={() => handleDelete(deduction.id)}
																		className="text-red-600"
