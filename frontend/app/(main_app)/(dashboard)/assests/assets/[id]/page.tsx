  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className={` gap-6 ${(asset?.approval_status !== "active" && asset?.approvals?.length) ? "!grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-3" : ""}`}>
          ...
          <div className={`${(asset?.approval_status !== "active" && asset?.approvals?.length) ? "lg:col-span-2 xl:col-span-3 order-2 lg:order-1" : ""}`}>
                ...
                <div className="border-b border-gray-200 mb-6">
                  <nav className="-mb-px flex space-x-8">
                    <button
                      ...
                      className={`py-2 px-1 border-b-2 font-medium text-sm ${activeTab === "assignment-history"
