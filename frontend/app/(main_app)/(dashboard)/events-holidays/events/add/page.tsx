...
// console.log("Employees: ", employees);
  ...
  const filteredEmployees = employees.filter(employee =>
    ...
    (employee.department?.name && employee.department.name.toLowerCase().includes(employeeSearchTerm.toLowerCase()))
  );
            ...
            <div className="">
              <div className="pb-6">
                <h2 className="text-2xl font-bold text-[#232E3F]">
                  {currentStep === 3 ? "Schedule & Review" : steps.find((s) => s.id === currentStep)?.title}
                </h2>
              </div>
              <div className="p-6">
                <form onSubmit={handleSubmit} className={`space-y-6 ${loading ? 'pointer-events-none opacity-60' : ''}`}>
                  {currentStep === 1 && (
                    ...
                    <div className="space-y-6">
                      ...
                      {formData.target_audience === "department" && (
                        <div className="space-y-3">
                          ...
                          >
                            <SelectTrigger className="h-12 text-base border-slate-200 focus:border-blue-500">
                              <SelectValue placeholder={departmentsLoading ? "Loading departments..." : "Choose department"} />
                            </SelectTrigger>
                            <SelectContent>
                              {departmentsLoading ? (
                  ...
                  {currentStep === 3 && (
                    <div className="space-y-6">
                      ...
                      <div className="text-center py-4">
                        <h3 className="text-lg font-medium text-slate-700 mb-2">Review Your Event</h3>
                        <p className="text-slate-600">Please review all the information before creating your event.</p>
                      </div>
