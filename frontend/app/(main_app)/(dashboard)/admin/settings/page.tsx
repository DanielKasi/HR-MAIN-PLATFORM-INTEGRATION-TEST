                            ...
                            <TableCell className="px-2 py-2 sm:px-3 sm:py-2 md:px-6 md:py-4">
                              <div className="flex items-center space-x-1 sm:space-x-2">
                                ...
                                <Button
                                  ...
                                  className="text-red-600 hover:text-red-700 h-7 w-7 sm:h-8 sm:w-8 md:h-9 md:w-9 p-0"
                                  title="Delete"
                                >
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <div className="mt-3">
          <Select
            ...
            onValueChange={(value) => setSelectedBranchId(Number.parseInt(value))}
          >
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        ...
        <div className="mt-3">
          <Select
            ...
            onValueChange={(value) => setSelectedLocationComparisonBranchId(Number.parseInt(value))}
          >
            <SelectTrigger className="w-[300px]">
              <SelectValue placeholder="Select a branch" />
            </SelectTrigger>
          ...
          <div className="p-4 md:p-6">
            <div className="flex lg:flex-col space-x-2 lg:space-x-0 lg:space-y-2 overflow-x-auto lg:overflow-x-visible pb-2 lg:pb-0">
              ...
              <button
                ...
                className={`flex-shrink-0 lg:w-full flex items-center space-x-3 p-3 lg:p-4 rounded-lg text-left transition-colors ${
                  activeTab === "branch_penalties" ? "bg-blue-50 border border-blue-200" : "hover:bg-gray-50"
                }`}
              >
                <Icon
              ...
              <button
                ...
                className={`flex-shrink-0 lg:w-full flex items-center space-x-3 p-3 lg:p-4 rounded-lg text-left transition-colors ${
                  activeTab === "location_comparison" ? "bg-green-50 border border-green-200" : "hover:bg-gray-50"
                }`}
              >
                <Icon
