	...
	if (loading) {
		return (
			<div className="flex items-center justify-center h-64">
				<div className="text-center text-sm sm:text-base">Loading user details...</div>
			</div>
		);
	}
					...
					<CardContent className="p-0">
						...
						<div className="border-t border-[#e5e7eb]">
							...
							{activeTab === "branches" && (
								<div className="p-4 sm:p-6">
									<div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4">
										<h3 className="text-base sm:text-lg font-medium">Branch Access</h3>
										<AddBranchForm
							...
							{activeTab === "permissions" && (
								<div className="p-4 sm:p-6">
									<div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4">
										<h3 className="text-base sm:text-lg font-medium">Role & Permissions</h3>
							...
							{activeTab === "attendance" && (
								<div className="p-4 sm:p-6">
									<h3 className="text-base sm:text-lg font-medium mb-4">Attendance Records</h3>
									{employee ? (
