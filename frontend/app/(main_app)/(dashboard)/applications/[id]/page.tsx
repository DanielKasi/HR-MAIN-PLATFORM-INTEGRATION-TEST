            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div className="flex flex-col items-start xl:flex-row xl:items-center gap-4">
                <div className="flex items-center justify-start gap-8">
                  <Button variant="ghost" className="rounded-full aspect-square" size="sm" onClick={handleGoBack}>
                    <ArrowLeft className="h-4 w-4" />
                  </Button>
                  <h1 className="text-xl md:text-2xl: font-bold">Application from {application.applicant_name}</h1>
