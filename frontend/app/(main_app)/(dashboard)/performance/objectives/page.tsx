...
export default function ObjectivesPage() {
    ...
    const [editingObjective, setEditingObjective] = useState<IObjectives | undefined>()
    ...
    const handleEdit = (objective: IObjectives) => {
        setEditingObjective(objective)
        setModalOpen(true)
    }

    const handleSubmit = async (data: IObjectivesFormData) => {
        setSubmitting(true)
        try {
            if (editingObjective) {
    ...
    const handleDelete = async (objective: IObjectives) => {
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <p className="text-slate-600 text-lg">Define and manage performance objectives and goals</p>
                        </div>
                    </div>
                </div>
