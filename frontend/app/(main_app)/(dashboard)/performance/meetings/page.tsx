...
export default function MeetingsPage() {
	...
	const [meetingToDelete, setMeetingToDelete] = useState<IMeeting | null>(null);
	...
	const handleDelete = async (meeting: IMeeting) => {
		...
		try {
			...
			showErrorToast({ error, defaultMessage: "Failed to delete meeting" });
		}
	};
			...
			<div className="">
					...
					<div className="flex items-center gap-4 mb-4">
						...
						<div>
							...
							<p className="text-slate-600 text-lg">
								Schedule and manage performance review meetings
							</p>
						</div>
					</div>
				</div>
				...
				{meetingToDelete && (
					<ConfirmationDialog
						...
						title={`Delete ${meetingToDelete.mode} meeting ?`}
						onConfirm={() => handleDelete(meetingToDelete)}
						onClose={() => {
