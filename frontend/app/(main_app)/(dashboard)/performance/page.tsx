                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-slate-500">{currentInstitution?.institution_name || "Institution"}</span>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div className="flex items-center gap-4">
                                            {module.title === "Performance Periods" && (
                                                <>
                                                    <span className="text-slate-500">
                                                        Total: <span className="font-medium text-slate-700">{module.stats.total}</span>
                                                    </span>
                                                    <span className="text-slate-500">
                                                        Active: <span className="font-medium text-green-600">{module.stats.active}</span>
                                                    </span>
                                                </>
                                            )}
                                            ...
                                            {module.title === "Objectives" && (
                                                <>
                                                    ...
                                                    <span className="text-slate-500">
                                                        Assigned: <span className="font-medium text-blue-600">{module.stats.with_assignees}</span>
                                                    </span>
                                                </>
                                            )}
                                            ...
                                            {module.title === "Employee Objectives" && (
                                                <>
                                                    ...
                                                    <span className="text-slate-500">
                                                        On Track: <span className="font-medium text-green-600">{module.stats.on_track}</span>
                                                    </span>
                                                </>
                                            )}
                                            ...
                                            {module.title === "360° Feedback" && (
                                                <>
                                                    ...
                                                    <span className="text-slate-500">
                                                        Avg Rating:{" "}
                                                        <span className="font-medium text-yellow-600">{module.stats.average_rating}/10</span>
                                                    </span>
                                                </>
                                            )}
                                            ...
                                            {module.title === "Meetings" && (
                                                <>
                                                    ...
                                                    <span className="text-slate-500">
                                                        Upcoming: <span className="font-medium text-blue-600">{module.stats.upcoming}</span>
                                                    </span>
                                                </>
                                            )}
                                        </div>
