													...
													<TableHead>
														<div className="flex items-center gap-2">
															...
															<Button
																onClick={() =>
																	setOrdering(
																		ordering === "request_reference_code"
																			? ""
																...
																size="sm"
																variant={
																	ordering === "request_reference_code" ? "default" : "outline"
																}
																type="button"
															>
													...
													<TableHead>
														<div className="flex items-center gap-2">
															...
															<Button
																onClick={() =>
																	setOrdering(
																		ordering === "requester__user__fullname"
																			? ""
																...
																size="sm"
																variant={
																	ordering === "requester__user__fullname" ? "default" : "outline"
																}
																type="button"
															>
																<Icon icon="hugeicons:sorting-02" className="!h-4 !w-4" />
														...
														<TableCell>
															<DropdownMenu>
																...
																<DropdownMenuContent align="end">
																	...
																	<ProtectedPage
																		permissionCode={[PERMISSION_CODES.CAN_EDIT_ASSET_REQUESTS]}
																	>
																	...
																	<ProtectedPage
																		permissionCode={[PERMISSION_CODES.CAN_DELETE_ASSET_REQUESTS]}
																	>
																		<DropdownMenuItem
