												...
												<TableRow>
													<TableHead>
														<div className="flex items-center gap-2">
															...
															<Button
																onClick={() =>
																	setOrdering(ordering === "alloc_code" ? "" : "alloc_code")
																}
																size="sm"
													...
													<TableHead>
														<div className="flex items-center gap-2">
															...
															<Button
																onClick={() =>
																	setOrdering(
																		ordering === "allocated_to__user__fullname"
																			? ""
													...
													<TableHead>
														<div className="flex items-center gap-2">
															...
															<Button
																onClick={() =>
																	setOrdering(
																		ordering === "allocated_by__user__fullname"
																			? ""
														...
														<TableCell>
															<DropdownMenu>
																...
																<DropdownMenuContent align="end">
																	...
																	<ProtectedPage
																		permissionCode={[PERMISSION_CODES.CAN_EDIT_ASSET_ALLOCATIONS]}
																	>
																		<DropdownMenuItem
																	...
																	<ProtectedPage
																		permissionCode={[PERMISSION_CODES.CAN_DELETE_ASSET_ALLOCATIONS]}
																	>
																		<DropdownMenuItem
