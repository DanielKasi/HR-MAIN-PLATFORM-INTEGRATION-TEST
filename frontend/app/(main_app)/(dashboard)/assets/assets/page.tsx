						...
						{({ data, loading, refresh }) => {
							...
							const filteredResults = data.results.filter((asset) => {
								const matchesCategory =
									categoryFilter === "all" || asset.category?.id === parseInt(categoryFilter);
														...
														<TableCell>
															<DropdownMenu>
																...
																<DropdownMenuContent align="end">
																	...
																	<ProtectedPage
																		permissionCode={[PERMISSION_CODES.CAN_EDIT_ASSETS]}
																	>
																	...
																	<ProtectedPage
																		permissionCode={[PERMISSION_CODES.CAN_DELETE_ASSETS]}
																	>
																		<DropdownMenuItem
