	...
	return (
		<div className="min-h-screen bg-gray-50">
			<div className=" px-4 sm:px-6 lg:px-8 py-6">
				...
				<div
					className={` gap-6 ${asset?.approval_status !== "active" && asset?.approvals?.length ? "!grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-3" : ""}`}
				>
					...
					<div
						className={`${asset?.approval_status !== "active" && asset?.approvals?.length ? "lg:col-span-2 xl:col-span-3 order-2 lg:order-1" : ""}`}
					>
