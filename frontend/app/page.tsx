							...
							<CardContent className="p-6">
								<div className="space-y-4">
									<p className="text-myblack">
										"PERACOSOFT has completely transformed how we manage our workforce. The
										automation saves us hours every week, and the insights help us make better
										decisions."
									</p>
									<div className="flex items-center gap-3">
										<img
				...
				<div className="mx-auto max-w-4xl px-6 text-center">
					<div className="space-y-4">
						...
						<p className="text-white/90">
							Our dedicated HR Manager service is designed to simplify and optimize your human
							resources processes. With a skilled HR professional at your disposal, you can focus on
					...
					<div className="space-y-12">
						<div className="mx-auto max-w-3xl text-center">
							...
							<p className="mt-4 text-gray-600">
								From recruitment to retirement, our comprehensive platform handles every aspect of
							...
							<Card className="bg-myblack text-white border-0 shadow-lg">
								<CardContent className="p-6">
									<div className="space-y-4">
										...
										<p className="text-white/90">
											Streamline hiring with applicant tracking, job postings, automated screening,
											and collaborative tools to build winning teams.
										</p>
									</div>
								</CardContent>
							</Card>
								...
								<CardContent className="p-6">
									<div className="space-y-4">
										...
										<p className="text-gray-600">
											...
											calculations, and secure employee salary management system.
										</p>
									</div>
								</CardContent>
							</Card>
							...
							<Card className="bg-myblack text-white border-0 shadow-lg">
								<CardContent className="p-6">
									<div className="space-y-4">
										...
										<p className="text-white/90">
											Centralize employee data, performance records, and profiles to simplify
											workforce management, improve productivity, and empower HR teams.
										</p>
									</div>
								</CardContent>
							</Card>
							...
							<Card className="bg-white border shadow-lg">
								<CardContent className="p-6">
									<div className="space-y-4">
										...
										<p className="text-gray-600">
											Easily manage company assets with real-time tracking, assignment, and recovery
											for improved accountability and resource optimization.
										</p>
									</div>
								</CardContent>
							</Card>
							...
							<Card className="bg-myblack text-white border-0 shadow-lg">
								<CardContent className="p-6">
									<div className="space-y-4">
										...
										<p className="text-white/90">
											Automate leave requests, approvals, and attendance tracking with smart
											calendars, ensuring compliance and seamless employee scheduling.
										</p>
									</div>
								</CardContent>
							</Card>
							...
							<Card className="bg-white border shadow-lg">
								<CardContent className="p-6">
									<div className="space-y-4">
										...
										<p className="text-gray-600">
											Plan, track, and celebrate events, holidays, and milestones with shared
											calendars that boost workplace culture and engagement.
										</p>
									</div>
								</CardContent>
							</Card>
				...
				<div className="mx-auto max-w-7xl px-6">
					<div className="grid gap-16 lg:grid-cols-2 lg:gap-20">
						...
						<div className="space-y-8">
							<div className="space-y-4">
								<h2 className="text-3xl md:text-4xl font-bold text-myblack">
									Empowering HR Teams, Engaging Employees
								</h2>
								<p className="text-gray-600">
							...
							<div className="space-y-6">
								<div className="flex gap-4">
									...
									<div>
										...
										<p className="text-gray-600">
											Reduce manual tasks by 80% with intelligent workflows
										</p>
									</div>
								</div>
								<div className="flex gap-4">
								...
								<div className="flex gap-4">
									...
									<div>
										...
										<p className="text-gray-600">
											Grows with your business while maintaining enterprise security
										</p>
									</div>
								</div>
								<div className="flex gap-4">
									...
									<div>
										...
										<p className="text-gray-600">
											Empower employees with self-service portals and mobile access
										</p>
									</div>
								</div>
							</div>
				...
				<div className="mx-auto max-w-7xl px-6">
					<div className="space-y-12">
						<div className="mx-auto max-w-3xl text-center">
							...
							<p className="mt-4 text-gray-600">
								Foster a positive workplace culture with integrated tools for celebrations, events,
								and team engagement.
							</p>
						</div>
									...
									<div className="space-y-4">
										<div>
											...
											<p className="text-gray-700">
												Never miss important dates, celebrations, and team events
											</p>
										</div>
								...
								<CardContent className="p-6">
									<div className="space-y-4">
										<div>
											...
											<p className="text-gray-700">
												Celebrate your team with automated birthday notifications
											</p>
										</div>
								...
								<CardContent className="p-6">
									<div className="space-y-4">
										<div>
											...
											<p className="text-gray-700">
												Acknowledge achievements and boost team morale
											</p>
										</div>
										<div className="flex items-center gap-2">
					...
					<div className="mx-auto max-w-4xl px-6 text-center">
						<div className="space-y-8">
							<div className="space-y-4">
								...
								<p className="text-white/90">
									Join thousands of companies that have transformed their HR operations with
									PERACOSOFT. Start for free today.
								</p>
							</div>
							<Button
								size="lg"
								className="bg-primary hover:bg-primary/80 text-white px-8 py-6 text-lg rounded-full"
							>
								Join Now Free
								<ArrowRight className="ml-2 h-5 w-5" />
							</Button>
