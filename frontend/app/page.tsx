      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold">PERACOSOFT</span>
          </div>
            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 xl:grid-cols-2 items-center">
              <div className="flex flex-col justify-center space-y-6 animate-fade-in-up">
                <div className="space-y-4">
                  ...
                  >
                    PERACOSOFT empowers organizations to streamline HR processes, enhance employee engagement, and drive business growth through intelligent workforce management solutions.
                  </motion.p>
                </div>
                <motion.div
          ...
          <div className="container mx-auto px-4 md:px-6 relative">
            <div className="flex flex-col items-center justify-center space-y-6 text-center">
              ...
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Join hundreds of organizations already using PERACOSOFT to streamline their human resource operations and improve employee satisfaction.
                </p>
              </div>
      ...
      <footer className="border-t bg-background">
        <div className="container mx-auto flex flex-col gap-6 py-8 md:flex-row md:items-center md:justify-between md:py-12">
          ...
          <div className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} PERACOSOFT. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
