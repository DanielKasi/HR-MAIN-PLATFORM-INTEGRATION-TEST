...
type SaveJobAdvertForm = ActionWithPayLoad<MISC_ACTION_TYPES.SAVE_JOB_ADVERT_FORM, JobAdvertCompleteFormData>
type ClearJobAdvertForm = Action<MISC_ACTION_TYPES.CLEAR_JOB_ADVERT_FORM>

type SaveApplicationForm = ActionWithPayLoad<MISC_ACTION_TYPES.SAVE_APPLICATION_FORM, JobApplicationCompleteFormData>
type ClearApplicationForm = Action<MISC_ACTION_TYPES.CLEAR_APPLICATION_FORM>

export type MiscAction = ToggleSideBar|OpenSideBar| CloseSideBar|SaveEmployeeForm|ClearEmployeeForm|SaveJobAdvertForm|ClearJobAdvertForm|SaveApplicationForm|ClearApplicationForm
...
export const saveJobAdvertForm = (jobAdvertForm: JobAdvertCompleteFormData): SaveJobAdvertForm => createAction(MISC_ACTION_TYPES.SAVE_JOB_ADVERT_FORM, jobAdvertForm)
export const clearJobAdvertForm = (): ClearJobAdvertForm => createAction(MISC_ACTION_TYPES.CLEAR_JOB_ADVERT_FORM)

export const saveApplicationForm = (applicationForm: JobApplicationCompleteFormData): SaveApplicationForm => createAction(MISC_ACTION_TYPES.SAVE_APPLICATION_FORM, applicationForm)
export const clearApplicationForm = (): ClearApplicationForm => createAction(MISC_ACTION_TYPES.CLEAR_APPLICATION_FORM)
