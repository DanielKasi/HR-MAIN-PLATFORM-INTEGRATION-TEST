...
const PATH_MAP: { [key: string]: string } = {
	...
	branchworkingday: "/admin/working-days",
	...
	branchpenalty: "/branch-penalty",
	bankaccounts: "/admin/bank-accounts",
	banktype: "/admin/bank-types",
	...
	institutionbankaccount: "/approvals/institution-bank-accountss",
	...
	keyresults: "/performance/key-results",
	...
	offboardings: "/approvals/offboardings",
	...
	branchspotcheck: "/branch-spotcheck",
