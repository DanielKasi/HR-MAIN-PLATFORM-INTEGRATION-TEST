...
export const BonusPointSettingsSelect = ({
  ...
  const handleSelect = (itemId: string | number, _item: PaginatedSelectItem<IBonusPointSettings>) => {
  ...
  const handleRemove = (itemId: string | number, _item: PaginatedSelectItem<IBonusPointSettings>) => {
    if (multiple) {
