        ...
        <div className="py-4">
          <div className="bg-muted p-4 rounded-lg">
            ...
            <div className="space-y-1 text-sm text-muted-foreground">
              <p><strong>Asset:</strong> {assetReturn.asset?.asset_name}</p>
              <p><strong>Serial Number:</strong> {assetReturn.asset?.serial_number}</p>
              <p><strong>Condition:</strong> {assetReturn.asset_condition}</p>
              <p><strong>Return Date:</strong> {new Date(assetReturn.created_at).toLocaleDateString()}</p>
              {assetReturn.notes && (
                <p><strong>Notes:</strong> {assetReturn.notes}</p>
              )}
            </div>
          </div>
        </div>
