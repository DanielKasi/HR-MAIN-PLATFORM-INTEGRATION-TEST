		...
		<Dialog open={isOpen} onOpenChange={onClose}>
			<DialogContent className="sm:max-w-[600px]">
				<DialogHeader>
					...
					<DialogDescription>
						{editingType
							? "Update the bank type information below."
							: "Add a new bank type to your organization."}
					</DialogDescription>
				</DialogHeader>
					...
					<div className="space-y-4">
						<div className="space-y-2">
							...
							{errors.bank_fullname && (
								<p className="text-sm text-red-500">{errors.bank_fullname}</p>
							)}
						</div>
