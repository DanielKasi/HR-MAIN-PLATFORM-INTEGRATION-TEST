...
import type { IEmployeeBonusPoint, IEmployeeBonusPointFormData, IEmployee } from "@/types/types.utils";
...
export function BonusPointsModal({ isOpen, onClose, bonusPoint, employee, onSubmit }: BonusPointsModalProps) {
