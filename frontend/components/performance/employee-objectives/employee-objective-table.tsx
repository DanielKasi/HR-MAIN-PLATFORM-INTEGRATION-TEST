    ...
    const columns: TableColumn<IEmployeeObjective>[] = [
        {
            ...
            render: (item) => (
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <div className="font-medium text-slate-900">{item.employee.user?.fullname || "Unknown"}</div>
                        <div className="text-sm text-slate-500">{item.employee.department?.name || "No department"}</div>
                    </div>
                </div>
            ),
        },
                ...
                <div>
                    {item.key_result ? (
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-slate-600 truncate max-w-xs">{item.key_result.title}</span>
                        </div>
                    ) : (
