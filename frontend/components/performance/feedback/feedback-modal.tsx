...
export function FeedbackModal({ isOpen, onClose, feedback, onSubmit, isLoading }: FeedbackModalProps) {
    return (
        <PerformanceFormModal
            ...
            size="lg"
        >
            <FeedbackForm initialData={feedback} onSubmit={onSubmit} onCancel={onClose} isLoading={isLoading} />
        </PerformanceFormModal>
    )
}
