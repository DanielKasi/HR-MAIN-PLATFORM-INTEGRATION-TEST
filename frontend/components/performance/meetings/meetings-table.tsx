...
export function MeetingsTable({ meetings, onEdit, onDelete, onAdd, onSearch, isLoading }: MeetingsTableProps) {
    const columns: TableColumn<IMeeting>[] = [
        {
            ...
            render: (meeting) => (
                <div>
                    ...
                    {meeting.description && <div className="text-sm text-slate-500 line-clamp-2">{meeting.description}</div>}
                </div>
            ),
            className: "max-w-xs",
        },
                ...
                <div>
                    {meeting.organizer ? (
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-slate-600">{meeting.organizer.user?.fullname || "Unknown"}</span>
                        </div>
                    ) : (
