...
export default function ShiftRequestDialog({ isOpen, onOpenChange, onRequestSubmitted }: ShiftRequestDialogProps) {
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="flex justify-end space-x-2">
          ...
          <Button onClick={handleSubmitRequest} disabled={isSubmitting || !formData.shift || !formData.date}>
