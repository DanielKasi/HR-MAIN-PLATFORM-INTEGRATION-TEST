...
export function TasksCards({ branchId }: { branchId: string | null }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 my-6 py-4 cursor-pointer">
      ...
      >
        <div className="flex items-center">
          <span className="text-xl font-bold text-primary mr-2">{dashboardData?.incoming.count || 0}</span>
      ...
      >
        <div className="flex items-center">
          <span className="text-xl font-bold text-purple-500 mr-2">{dashboardData?.open.count || 0}</span>
      ...
      >
        <div className="flex items-center">
          <span className="text-xl font-bold text-red-500 mr-2">{dashboardData?.critical.count || 0}</span>
      ...
      >
        <div className="flex items-center">
          <span className="text-xl font-bold text-gray-600 mr-2">{dashboardData?.expired.count || 0}</span>
      ...
      >
        <div className="flex items-center">
          <span className="text-xl font-bold text-green-500 mr-2">{dashboardData?.outgoing.count || 0}</span>
