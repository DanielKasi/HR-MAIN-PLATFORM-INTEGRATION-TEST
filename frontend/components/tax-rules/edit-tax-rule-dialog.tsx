...
export function EditTaxRuleDialog({ taxRule, isOpen, onClose, onSuccess }: EditTaxRuleDialogProps) {
							...
							<div className="relative">
								<Input
									...
									onChange={(e) =>
										setFormData({
											...formData,
											tax_rule_percentage: parseFloat(e.target.value) || undefined,
										})
									}
							...
							<div className="relative">
								<Input
									...
									onChange={(e) =>
										setFormData({
											...formData,
											tax_rule_fixed_amount: parseFloat(e.target.value) || undefined,
										})
									}
						...
						<div className="space-y-3">
							...
							<div className="relative">
								<Input
									...
									onChange={(e) =>
										setFormData({ ...formData, salary_from: parseFloat(e.target.value) || 0 })
									}
									placeholder="e.g., 0"
									disabled={isSubmitting}
									className="rounded-xl border-gray-200 focus:border-orange-500 focus:ring-orange-500/20 text-base pl-8"
						...
						<div className="space-y-3">
							...
							<div className="relative">
								<Input
									...
									onChange={(e) =>
										setFormData({ ...formData, salary_to: parseFloat(e.target.value) || 0 })
									}
