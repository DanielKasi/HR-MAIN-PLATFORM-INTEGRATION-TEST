					...
					<div className="bg-gray-50 rounded-xl p-4">
						...
						<div className="space-y-2 text-sm text-gray-600">
							...
							<div>
								...
								<span className="ml-2">
									{taxRule.salary_from && formatCurrency(taxRule.salary_from || 0)}
									{taxRule.salary_to && "-" + formatCurrency(taxRule.salary_to)}
								</span>
							</div>
							<div>
					...
					<div className="mt-4 p-4 bg-red-50 rounded-xl border border-red-200">
						<div className="flex items-start gap-3">
							...
							<div className="text-sm text-red-800">
								...
								<p>
									Deleting this tax rule will permanently remove it from the system. This may affect
									tax calculations for employees in the specified salary range.
								</p>
							</div>
						</div>
					</div>
