...
import type { IInstitutionSpotCheckSetting, IInstitutionSpotCheckSettingFormData } from "@/types/types.utils";
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white rounded-lg p-4 border border-green-200">
              <div className="text-sm text-gray-600 mb-1">Lower Threshold(Minimum spot check frequency)</div>
              <div className="text-lg font-semibold text-gray-900">{institutionSpotcheckSetting.lower_threshold}</div>
            </div>
            <div className="bg-white rounded-lg p-4 border border-green-200">
              <div className="text-sm text-gray-600 mb-1">Upper Threshold(Maximum spot check frequency)</div>
              <div className="text-lg font-semibold text-gray-900">{institutionSpotcheckSetting.upper_threshold}</div>
            </div>
            <div className="bg-white rounded-lg p-4 border border-green-200">
            ...
            <div className="bg-white rounded-lg p-4 border border-green-200">
              <div className="text-sm text-gray-600 mb-1">Late Starts After(How long a respondant will be termed late)</div>
              <div className="text-lg font-semibold text-gray-900">{institutionSpotcheckSetting.late_starts_after_minutes}</div>
            </div>
          </div>
        </div>
      ) : (
      ...
      <SpotcheckConfigModal
        ...
        title={institutionSpotcheckSetting ? "Update Institution Spotcheck Configuration" : "Create Institution Spotcheck Configuration"}
      />
    </div>
  );
};
