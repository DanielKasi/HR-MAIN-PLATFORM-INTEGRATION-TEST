              ...
              {loading ? (
                <div className="flex items-center justify-center py-8 sm:py-12">
                  <div className="flex items-center space-x-2">
                    <Icon icon="hugeicons:loading-03" className="w-4 h-4 sm:w-5 sm:h-5 animate-spin text-gray-500" />
                    ...
                    >
                      <div className="flex items-center space-x-3 sm:space-x-4">
                        ...
                        <div className="min-w-0 flex-1">
                          <h3 className="font-medium text-gray-900 text-sm sm:text-base truncate">{document.document_title}</h3>
