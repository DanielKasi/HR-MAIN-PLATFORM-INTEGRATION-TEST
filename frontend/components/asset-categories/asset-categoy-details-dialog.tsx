...
export default function AssetCategoryDetailsModal({ isOpen, onClose, assetCategory, assetCount = 0 }: AssetCategoryDetailsModalProps) {
          ...
          <div className="grid grid-cols-1 gap-4 sm:gap-6">
            <div className="space-y-2">
              ...
              <div className="p-3 bg-gray-50 rounded-md border">
                <span className="font-medium text-sm sm:text-base">{assetCategory.category_name}</span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="p-3 bg-gray-50 rounded-md border min-h-[60px] sm:min-h-[80px]">
                {assetCategory.category_description ? (
                  <span className="text-gray-700 text-sm sm:text-base">{assetCategory.category_description}</span>
                ) : (
