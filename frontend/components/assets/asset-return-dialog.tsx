...
export function AssetReturnDialog({ asset, onReturn, trigger }: AssetReturnDialogProps) {
  ...
  const handleInputChange = (
    field: keyof IAssetReturnFormData,
    value: string
  ) => {
    setFormData((prev) => ({
      ...prev,
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handleInputChange("asset_condition", value as any)
                }
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="damaged">Damaged - Asset is damaged or non-functional</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
