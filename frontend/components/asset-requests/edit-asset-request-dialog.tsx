			...
			<DialogContent className="sm:max-w-[500px]">
				...
				<div className="space-y-6 py-4">
					...
					<div className="space-y-3">
						<Label className="text-sm text-gray-800">Asset</Label>
							...
							<div className="flex items-center space-x-2">
								...
								<div>
									...
									<p className="text-sm text-gray-600">
										...
										{request.asset.category?.category_name || "Unknown Category"}
									</p>
								</div>
							</div>
						</div>
					...
					<div className="space-y-3">
						<Label className="text-sm text-gray-800">Current Status</Label>
						<div className="p-3 bg-gray-50 rounded-lg border">
							<div className="flex items-center space-x-2">
								<span
					...
					<div className="space-y-3">
						<Label className="text-sm text-gray-800">Requester</Label>
						<div className="p-3 bg-gray-50 rounded-lg border">
