			...
			<DialogContent className="sm:max-w-[500px] rounded-2xl border-0 shadow-2xl">
				<DialogHeader className="space-y-4 pb-6">
					...
					<DialogDescription className="text-gray-600 text-center text-base leading-relaxed">
						...
						<span className="font-semibold text-gray-900">"{allowanceType?.name}"</span>? This
						action cannot be undone and will permanently remove this allowance type from your
						system.
					</DialogDescription>
				</DialogHeader>
				<DialogFooter>
