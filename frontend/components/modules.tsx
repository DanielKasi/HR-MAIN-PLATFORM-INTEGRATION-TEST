...
export default function Modules() {
  ...
  const modules = [
    {
      ...
      link: "/hrms/dashboard",
      icon: (
        <Icon icon="hugeicons:user-settings-01" width="24" height="24" />
      ),
    },
    {
      id: "accounting",
      ...
      icon: (
        <Icon icon="hugeicons:bitcoin-graph" width="24" height="24" />
      ),
    },
    {
      id: "crm",
      ...
      link: "/crm/dashboard",
      icon: (
        <Icon icon="hugeicons:user-multiple-02" width="24" height="24" />
      ),
    },
  ];
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="bg-white p-4 rounded-2xl shadow-lg w-64" sideOffset={5}>
